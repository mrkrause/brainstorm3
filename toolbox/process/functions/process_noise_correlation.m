...
% PROCESS_RASTERPLOT_NAS: Computes the noise correlation for each Neuron
% combination
% 
...
% Description the process
    ...
    sProcess.options.eventname.Value   = 'ie. ST1, ST2, ST3';
...
function OutputFiles = Run(sProcess, sInputs) %#ok<DEFNU>
    ...
    %%%%%%%%%%% BRAINSTORM FAILS TO DISPLAY Electrode 1 : Neuron 2 %%%%%%%%
    % PROBABLY DOENS'T TAKE 2 NUMBERS ON THE SAME LABEL
...
%             labelsForDropDownMenu_temp{iNeuron} = ['Elect ' num2str(wordsInLabel{3}) ' Neuron 1']; % Rename 'Spikes Electrode 1' to Electrode 1 : Neuron 1
%         else
%             wordsInLabel = strsplit(labelsForDropDownMenu{iNeuron}, ' ');
%             labelsForDropDownMenu_temp{iNeuron} = ['Elect ' num2str(wordsInLabel{3}) ' Neuron ' num2str(labelsForDropDownMenu{iNeuron}(multiple_neurons_indicator(1)+1:multiple_neurons_indicator(2)-1))];
